...
module.exports.csdl2openapi = function (
   ...
   */
  function customParameters(parameters, restrictions) {
    for (const custom of restrictions.CustomHeaders || []) {
      parameters.push(customParameter(custom, "header"));
    }

    for (const custom of restrictions.CustomQueryOptions || []) {
      parameters.push(customParameter(custom, "query"));
    }
  }
    ...
    parameters.forEach((p) => {
      ...
      if (
        ...
        if (
          !p.$Type ||
          p.$Type === "Edm.String" ||
          (type && (!type.$Type || type.$Type === "Edm.String"))
        ) {
          if (description) param.description += "  \n";
          else param.description = "";
          param.description +=
