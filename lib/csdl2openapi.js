...
module.exports.csdl2openapi = function (
    ...
    const derivedTypes = {};
    const alias = {};
    preProcess(csdl, boundOverloads, derivedTypes, alias);
     ...
     */
    function preProcess(csdl, boundOverloads, derivedTypes, alias) {
    ...
    function vocabularies(csdl, alias) {
        const terms = {
            ...
            Core: ['Computed', 'Description', 'Immutable', 'Permissions']
        };
        const v = {};
