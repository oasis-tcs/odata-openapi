...
module.exports.csdl2openapi = function (
  ...
  function pathValuePrefix(typename) {
    ...
    if (typename === "Edm.Binary") return "binary'";
    else if (typename.startsWith("Edm.Geography")) return "geography'";
    else if (typename.startsWith("Edm.Geometry")) return "geometry'";
