    ...
    */
                ...
                'application/json': {
                    schema: type.$Collection
                        ? {
                            ...
                            properties: {
                                [`@${csdl.$Version > '4.0' ? '' : 'odata.'}count`]: ref('count'),
                                value: s
                            }
                        }
                        : s
    ...
    function schemasForStructuredType(schemas, qualifier, name, type) {
        ...
        if (type && type.$BaseType) {
            allProperties[`@${csdl.$Version > '4.0' ? '' : 'odata.'}type`] = ref('type');
            creProperties[`@${csdl.$Version > '4.0' ? '' : 'odata.'}type`] = ref('type');
        }
    ...
    /**
     * Construct OData type response
     * @return {object} Type response schema
     */
    function type() {
        return { type: "string" };
    }
