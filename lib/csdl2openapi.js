...
module.exports.csdl2openapi = function (
    ...
    function vocabularies(csdl, alias) {
        const terms = {
            Capabilities: ['CountRestrictions', 'DeleteRestrictions', 'FilterRestrictions', 'InsertRestrictions',
                'SearchRestrictions', 'SelectSupport', 'SkipSupported', 'SortRestrictions',
                'TopSupported', 'UpdateRestrictions', 'ReadRestrictions'],
