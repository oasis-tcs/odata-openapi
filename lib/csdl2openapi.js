...
module.exports.csdl2openapi = function (
  ...
  function schema(element, suffix = "", forParameter = false) {
    ...
    //TODO: breaking change, get rid of pathValuePrefix and pathValueSuffix, and instead add a pattern everywhere?
    // - Pro: easier to program
    // - Con: breaking change
    //  -Con: inconvenient for key values
    // --> construct pattern using pathValuePrefix/Suffix
