    ...
    function pathItems(paths, prefix, prefixParameters, element, root, sourceTag, targetTag, level) {
        ...
        if (element.$Collection) {
            pathItem.post = {
                ...
                tags: [sourceTag],
                requestBody: {
                    description: 'New entity', // Core.Description ||
                    required: true,
                    content: {
                        'application/json': {
                            schema: {
            ...
            if (sourceTag != targetTag) pathItem.post.tags.push(targetTag);
        ...
        if (element.$ContainsTarget) {
            if (element.$Collection) {
                ...
                //TODO: contained single - patch
                pathItem.patch = {};

                //TODO: contained single - delete 
                if (element.$Nullable)
