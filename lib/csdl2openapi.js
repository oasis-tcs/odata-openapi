...
module.exports.csdl2openapi = function (
    ...
    */
    ...
    function schemasForStructuredType(schemas, qualifier, name, type) {
        ...
        const metadata = csdl.$Version > '4.0' ? 
            { '@id':{ type: "string", readOnly: true }, '@etag': { type: 'string', readOnly: true, example: "W/\"08D7D40891852C76\"" }, '@type':{ type: 'string', readOnly: true } } : 
            { '@odata.id':{ type: "string", readOnly: true }, '@odata.etag': { type: 'string', readOnly: true, example: "W/\"08D7D40891852C76\"" }, '@odata.type':{ type: 'string', readOnly: true } };
