...
var argv = minimist(process.argv.slice(2), {
  string: ["o", "openapi-version", "t", "target", "scheme", "host", "basePath", "api-version"],
  boolean: ["skipBatchPath"],
  boolean: [
    "d",
    "diagram",
    "h",
...
Options:
 ...
 -v --api-version        API version to use, in case to version is provided in the source XML
