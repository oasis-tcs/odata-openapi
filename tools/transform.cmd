...
:process
  ...
  java.exe org.apache.xalan.xslt.Process -XSL V4-CSDL-to-openapi.xsl -PARAM scheme %2 -PARAM host %3 -PARAM basePath %4 -PARAM swagger-ui http://petstore.swagger.io -PARAM diagram YES -IN ..\examples\%1 -OUT %~n1.jsontmp
